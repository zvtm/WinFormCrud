Для запуска приложения с нужной таблицей необходимо скачать проект и открыть его Microsoft Visual Studio (WinFormCrud.sln)
...
Таблица которая использовалась имела столбцы:
